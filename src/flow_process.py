...
for scenario in SCENARIOS:
    ...
    hist_qtm_45_df[scenario] = hist_flow_m['flow'] + hist_km105['deeper_baseflow'] # assumption of no monthly delay for surface and shallow subsurface
    ...
    hist_qdm_45_df[scenario] = hist_km105['deeper_baseflow']
    ...
    fut_qtm_45_df[scenario] = fut_flow_m['flow'] + fut_km105['deeper_baseflow']
    ...
    fut_qdm_45_df[scenario] = fut_km105['deeper_baseflow']
    ...
    fut_qtm_85_df[scenario] = fut_flow_m['flow'] + fut_km105['deeper_baseflow']
    ...
    fut_qdm_85_df[scenario] = fut_km105['deeper_baseflow']
